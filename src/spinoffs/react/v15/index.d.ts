...
declare namespace React {
  ...
  interface ReactHTMLElement<T extends HTMLElement> extends DOMElement<
    HTMLAttributes<T>,
    T
  > {}
  ...
  interface DOMFactory<P extends DOMAttributes<T>, T extends Element> {
    (props?:
      | ClassAttributes<T> & P
      | null, ...children: ReactNode[]): DOMElement<P, T>;
  }
  ...
  interface ChangeTargetHTMLFactory<T extends HTMLElement> extends DOMFactory<
    ChangeTargetHTMLAttributes<T>,
    T
  > {}
  ...
  interface ChangeTargetHTMLProps<
    T extends HTMLElement
  > extends ChangeTargetHTMLAttributes<T>, ClassAttributes<T> {}
  ...
  interface ChangeTargetHTMLAttributes<
    T extends HTMLElement
  ...
  interface SVGAttributes<T> extends DOMAttributes<T> {
    ...
    // RDFa Attributes
    // TODO don't repeat these with what's already specified for HTML
    about?: string;
    content?: string; // TODO I added this one. Strangely, it's already specified for HTML elements, but not in the list of RDFa Attributes --AR
    datatype?: string;
    inlist?: any;
    prefix?: string;
    property?: string;

...
Kaavio.prototype.Footer = Footer;
Kaavio.prototype.FooterOpenButton = FooterOpenButton;
...
Kaavio.prototype.init = function() {
  ...
  kaavioComponent.vm = (function() {
    ...
    vm.init = function() {
      vm.state = {
        ...
        footer: m.prop(privateInstance.options.footer || privateInstance.options.editor)
        /*
      ...
      if (kaavioComponent.vm.state.footer() !== 'disabled') {
        privateInstance.footerOpenButton = privateInstance.footerOpenButton ||
            new FooterOpenButton(privateInstance);
        privateInstance.footerOpenButton.vm.init(privateInstance);
      }
  ...
  kaavioComponent.view = function(controller) {
    return [
      ...
      (function() {
        if (kaavioComponent.vm.state.footer() !== 'disabled') {
          return privateInstance.footerOpenButton.view();
        }
      }()),
      //*/
  ...
  if (privateInstance.instanceId > 1) {
    m.route(defaultRoute);
  }
  //*/
  //m.render(containerElement, kaavioComponent);
  m.module(containerElement, kaavioComponent);
};
    ...
    privateInstance.publicInstance = {
      ...
      getSourceData: function() {
        ...
        return {
          ...
          original: _.clone(privateInstance.sourceData.original, true),
...
Kaavio.prototype.getSourceData = function() {
  ...
  return {
    ...
    // TODO delete once pvjson -> gpml converter complete
    original: _.clone(this.sourceData.original, true),

...
var Kaavio = (function(window, $) {
   ...
   */
  var Kaavio = function(selector, options) {
    var privateInstance = this;
    var containerElement = options.selector;
    ...
    /*
    var parsedUri = m.route.parseQueryString(window.location.hash);
    var colors;
    ...
    options.highlights = highlightEntitiesList || [];
    //*/
    ...
    if (!privateInstance.options.manualRender) {
      ...
      privateInstance.publicInstance.render = privateInstance.init.bind(privateInstance);
    }
  ...
  Kaavio.prototype.init = function() {
    ...
    kaavioComponent.vm = (function() {
      ...
      vm.init = function() {
        ...
        /*
        privateInstance.options.highlights = JSON.parse(
            m.route.param('highlights'));
        //*/
    ...
    /*
    defaultRoute += '/highlights/' + encodeURIComponent(JSON.stringify(
          privateInstance.options.highlights));
    //*/

    // TODO make this handle multiple diagrams.
    if (privateInstance.instanceId === 1) {
      m.route(containerElement, defaultRoute, {
        //'/editor/:editorState/highlights/:highlights': kaavioComponent,

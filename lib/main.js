...
var Kaavio = function(containerElement, options) {
  ...
  privateInstance.jsonldRx = new JsonldRx()
  ...
  kaavioComponent.view = function(controller) {
    return [
      window.m('div', {
        ...
        window.m('header.annotation-header', {}, [
          window.m('span.annotation-header-move', {}, [
            window.m('i.icon-move'),
          ]),
          window.m('span.annotation-header-close', {}, [
            window.m('i.icon-remove'),
          ]),
          window.m('span.annotation-header-text', 'Header'),
          window.m('div.annotation-description', {}, [
            window.m('h2', {}, 'description'),
          ]),
        ]),
        window.m('span.annotation-items-container', {}, [
          ...
          window.m('ul.annotation-items-container-list'),
        ]),
      ]),

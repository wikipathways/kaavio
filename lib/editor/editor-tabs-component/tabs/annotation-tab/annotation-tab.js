...
annotationTab.vm = (function() {
  ...
  vm.init = function(kaavio) {
    ...
    vm.onClickDiagramContainer = function(selectedPvjsElement) {
      ...
      currentXref = _.find(kaavio.sourceData.pvjson.elements,
   ...
   *
   * @param {object} annotationEntity
   * @param {string} annotationEntity.type Type
   * @param {string} annotationEntity.displayName Short name for display
   * @param {string} annotationEntity.identifier Character string that differentiates this
   *                                          annotationEntity from other annotation entities.
   * @param {object} annotationEntity.isDataItemIn Dataset of which this annotationEntity
   *                                              reference is a member
   * @param {string} annotationEntity.isDataItemIn.id IRI
   * @param {string} annotationEntity.isDataItemIn.displayName Short name for display
   * @return
   */
  vm.updateControlValues = function(annotationEntity) {
...
annotationTab.view = function() {
  annotationTab.vm.disabled(!annotationTab.vm.selectedPvjsElement());

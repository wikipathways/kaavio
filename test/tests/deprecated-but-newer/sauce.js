...
describe("full-protocol (" + desired.browserName + ")", function() {
  ...
  it("should get interactions test page", function(done) {
    browser
      .get(
        "http://pointer.ucsf.edu/d3/r/pathvisiojs/test/one-diagram.html?gpml=http://pointer.ucsf.edu/d3/r/pathvisiojs/test/data/protocol/interactions.gpml.xml"
      )
      .title()
  ...
  it("should get data-nodes test page", function(done) {
    browser
      .get(
        "http://pointer.ucsf.edu/d3/r/pathvisiojs/test/one-diagram.html?gpml=http://pointer.ucsf.edu/d3/r/pathvisiojs/test/data/protocol/gpml-data-nodes.gpml.xml"
      )
      .title()
      .should.become("Pathvisiojs Simple Built Production Example")
      .waitForElementById("pvjs-diagram-1", wd.asserters.isDisplayed, 20000)

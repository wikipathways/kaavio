...
(function(process) {
  ...
  describe('BridgeDb.Organism.query', function() {
    ...
    it('should fetch all organisms', function(done) {
      ...
      bridgeDbInstance.organism.query().collect().map(JSON.stringify).pipe(highland.pipeline(function(s) {
        if (update) {
    ...
    it('should query organisms by name (Latin/string)', function(done) {
      ...
      bridgeDbInstance.organism.query('Homo sapiens').map(JSON.stringify).pipe(highland.pipeline(function(s) {
        if (update) {
          s.fork().map(function(dataString) {
            lkgDataString = dataString;
            return dataString;

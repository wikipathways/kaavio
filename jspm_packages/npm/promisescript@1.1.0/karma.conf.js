...
(function(process) {
  ...
  module.exports = function(config) {
    config.set({
      ...
      sauceLabs: {
        testName: require("./package.json!systemjs-json").name,
      ...
      browserify: {
        debug: true,
        transform: isCI ? null : [['browserify-istanbul', {ignore: ['**/*.handlebars']}]]
      },
      coverageReporter: {reporters: [{type: 'html'}, {type: 'text'}]},

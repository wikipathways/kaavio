...
core.AttrNodeMap.prototype.setNamedItemNS = function(arg) {
...
core.Element.prototype.getElementsByTagNameNS = function(namespaceURI, localName) {
  var nsPrefixCache = {};
...
core.Document.prototype.importNode = function(importedNode, deep) {
  ...
  function lastChance(el) {
    ...
    if (el._attributes) {
      ...
      for (var i = 0,
          len = el._attributes.length; i < len; i++) {
